...
class MyKivyApp(App):
    def build(self):
        ...
        # Song Title Display
        song_title = Label(text="Now Playing:"
                           , color=(1, 1, 1, 1), font_size=24, bold=True, size_hint=(1, None), size_hint_y=None, height=50, halign='center')
        ...
        play_button = Button(text="Play", size_hint=(None, None), size=(130, 50), background_normal='',
                             background_color=(0.2, 0.2, 0.2, 1), color=(1, 1, 1, 1), font_size=18)
        pause_button = Button(text="Pause", size_hint=(None, None), size=(130, 50), background_normal='',
                              background_color=(0.2, 0.2, 0.2, 1), color=(1, 1, 1, 1), font_size=18)
        next_button = Button(text="Next", size_hint=(None, None), size=(130, 50), background_normal='',
                             background_color=(0.2, 0.2, 0.2, 1), color=(1, 1, 1, 1), font_size=18)
        ...
        center_layout = BoxLayout(orientation='vertical', size_hint=(1, 1), padding=[10, 0], spacing=20)
